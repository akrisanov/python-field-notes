...
class Database:
    ...
    async def add_listener(self, channel, callback):
        """Create a long-lived socket connection to the database that will listen for events."""
        # creates a dedicated connection for each channel we want to listen on
        # this is expensive due to PostgreSQL architecture – just for learning purposes!
